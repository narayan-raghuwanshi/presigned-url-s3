...
const Popup: React.FC<ModalProps> = ({ isOpen, onClose, subHeading, buttonText }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-85 flex items-center justify-center">
            <div className="bg-black px-4 py-8 md:p-8 border-2 rounded-lg text-center flex items-center justify-center gap-10 flex-wrap max-w-[100vw] mx-4">
                <div className='flex text-xs md:text-sm justify-center items-center gap-3'>
